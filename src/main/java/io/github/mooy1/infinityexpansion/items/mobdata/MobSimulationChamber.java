...
public final class MobSimulationChamber extends TickingMenuBlock implements EnergyNetComponent {
    ...
    private static final ItemStack NO_CARD = new CustomItemStack(Material.BARRIER, "&c放入怪物資料卡!");
    ...
    private static ItemStack makeXpItem(int stored) {
        return new CustomItemStack(Material.LIME_STAINED_GLASS_PANE, "&a已儲存經驗值: " + stored, "", "&a> 點擊領取");
    }
